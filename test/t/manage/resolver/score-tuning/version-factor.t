...
sub get_first_offer_for {
	my ($score) = @_;
	my $score_option = defined $score ? "-o cupt::resolver::score::version-factor=$score" : '';
	return get_first_offer("$cupt install --importance=90 --satisfy other_tt -V -o debug::resolver=yes $score_option");
}
