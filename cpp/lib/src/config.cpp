...
void ConfigImpl::initializeVariables()
{
	regularVars =
	{
		...
		{ "cupt::cache::pin::addendums::hold", "9000000" },
		...
		{ "cupt::resolver::score::removal-of-autoinstalled", "1400" },
		...
		{ "cupt::resolver::score::version-factor", "40" },
		{ "cupt::resolver::score::negative-version-factor", "25" },
