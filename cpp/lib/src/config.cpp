...
void ConfigImpl::initializeVariables()
{
	regularVars =
	{
		...
		{ "cupt::cache::pin::addendums::downgrade", "-16000" },
		{ "cupt::cache::pin::addendums::hold", "2000000" },
		{ "cupt::cache::pin::addendums::not-automatic", "-6000" },
		{ "cupt::cache::pin::addendums::but-automatic-upgrades", "6200" },
		...
		{ "cupt::resolver::score::version-factor::priority-downgrade", "720" },
