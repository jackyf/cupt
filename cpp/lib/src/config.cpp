...
void ConfigImpl::initializeVariables()
{
	regularVars =
	{
		...
		{ "cupt::cache::pin::addendums::downgrade", "-25000" },
		{ "cupt::cache::pin::addendums::hold", "4000000" },
		{ "cupt::cache::pin::addendums::not-automatic", "-12000" },
		{ "cupt::cache::pin::addendums::but-automatic-upgrades", "12200" },
		...
		{ "cupt::resolver::max-leaf-count", "-1" },
		{ "cupt::resolver::max-solution-count", "32000" },
		...
		{ "cupt::resolver::score::new", "0" },
		{ "cupt::resolver::score::removal", "-1800" },
		{ "cupt::resolver::score::removal-of-autoinstalled", "1500" },
		{ "cupt::resolver::score::removal-of-essential", "-200000" },
		{ "cupt::resolver::score::upgrade", "20" },
		...
		{ "cupt::resolver::score::version-factor::priority-downgrade", "400" },
