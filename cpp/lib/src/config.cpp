...
void ConfigImpl::initializeVariables()
{
	regularVars =
	{
		...
		{ "cupt::cache::pin::addendums::downgrade", "-35000" },
		{ "cupt::cache::pin::addendums::hold", "5000000" },
		{ "cupt::cache::pin::addendums::not-automatic", "-16000" },
		{ "cupt::cache::pin::addendums::but-automatic-upgrades", "16200" },
		...
		{ "cupt::resolver::score::version-factor", "20" },
