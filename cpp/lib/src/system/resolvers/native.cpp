...
void NativeResolver::satisfyRelationExpression(const RelationExpression& relationExpression, bool invert)
{
	__impl->satisfyRelationExpression(relationExpression, invert);
}
