...
apt::cache-limit, apt::default-release, apt::install-recommends,
...
dpkg::post-invoke, dpkg::pre-install-pkgs, gpgv::trustedkeyring,
rpm::pre-invoke, rpm::post-invoke, quiet
