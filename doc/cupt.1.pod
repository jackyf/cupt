...
apt::get::allowunauthenticated, apt::get::automaticremove, apt::get::purge,
...
acquire::pdiffs, apt::cache-limit, apt::periodic::*, unattended-upgrade::*,
acquire::compressiontypes, apt::get::show-upgraded, rpm::pre-invoke,
rpm::post-invoke
