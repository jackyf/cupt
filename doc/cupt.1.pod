...
when removing packages (specified in the arguments), also delete their configuration files
...
dir::state::extendedstates, dir::state::status,
...
when doing update. True by default.
