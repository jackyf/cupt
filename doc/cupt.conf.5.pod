...
=item cupt::console::actions-preview::show-only-summary

boolean, if set to true, no details of planned actions will be shown in the
actions preview, only a summary will be shown. False by default.
